...
{
    public class DrenarManaSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Drenar Mana", "Exhaurire Mana",
            221,
            9032,
            Reagent.BlackPearl,
            Reagent.Bloodmoss,
            ...
            Reagent.SpidersSilk);
        public DrenarManaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly DrenarManaSpell m_Owner;
            public InternalTarget(DrenarManaSpell owner)
