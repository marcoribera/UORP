...
{
    public class CuraLeveSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Cura Leve", "Lux Remedii",
            224,
            9061,
            Reagent.Garlic,
            Reagent.Ginseng,
        ...
        public CuraLeveSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (this.CheckBSequence(m))
            {
                ...
                int toHeal = (int)(this.Caster.Skills[SkillName.Necromancia].Value * 0.2);
        ...
        {
            private readonly CuraLeveSpell m_Owner;
            public InternalTarget(CuraLeveSpell owner)
