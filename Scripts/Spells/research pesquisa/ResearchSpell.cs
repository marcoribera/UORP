...
namespace Server.Spells.Research
{
	public abstract class ResearchSpell : Spell
	{
		...
		public override SkillName CastSkill { get { return SkillName.Erudicao; } }
		public override SkillName DamageSkill { get { return SkillName.Erudicao; } }
		public override int CastRecoveryBase { get { return 1; } }

		public static double CastingSkill( Mobile from )
		{
			double skill = from.Skills[SkillName.Necromancia].Value;
				if ( from.Skills[SkillName.Arcanismo].Value > skill ){ skill = from.Skills[SkillName.Arcanismo].Value; }
		...
		{
			return ( from.Skills[SkillName.Necromancia].Value + from.Skills[SkillName.Arcanismo].Value + from.Skills[SkillName.PoderMagico].Value + from.Skills[SkillName.PoderMagico].Value ) / 2;
		}
		...
		public static int ComputePowerValue( Mobile from, int div )
		{
			...
			int v = (int) Math.Sqrt( ( from.Karma * -1 ) + 20000 + ( ( from.Skills.Necromancia.Fixed + from.Skills.Arcanismo.Fixed ) * 10 ) );
