...
namespace Server.Items
{
    ...
    public abstract class BaseInstrument : Item, ISlayer, IQuality, IResource
    {
        ...
        {
            return (bc != null && bc.AI == AIType.AI_Mage && bc.Skills[SkillName.Arcanismo].Base > 5.0);
        }
        ...
        {
            m.CheckSkill(SkillName.Tocar, 0.0, 120.0);

            return ((m.Skills[SkillName.Tocar].Value / 100) > Utility.RandomDouble());
        }
