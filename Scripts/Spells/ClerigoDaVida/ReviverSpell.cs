...
{
    public class ReviverSpell : ClerigoDaVidaSpell
    {
        ...
        public ReviverSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly ReviverSpell m_Owner;
            public InternalTarget(ReviverSpell owner)
