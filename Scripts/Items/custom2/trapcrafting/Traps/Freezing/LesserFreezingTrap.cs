...
namespace Server.Items
{
    public class FreezingLesserTrap : BaseTinkerTrap
    {
        ...
        private static string m_ArmedName = "uma armadilha de congelamento menor armada";
        private static string m_UnarmedName = "uma armadilha de congelamento menor desarmada";
