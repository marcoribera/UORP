...
namespace Server.Items
{
	...
	public class AdvancedHeavyCrossbow : CBaseRanged
	{
		...
		[Constructable]
		public AdvancedHeavyCrossbow() : base( 0x13FD )
		{
			Weight = 9.0;
			Layer = Layer.TwoHanded;
		}

        public AdvancedHeavyCrossbow(Serial serial)
            : base(serial)
		{
		}
		...
		{
            private AdvancedHeavyCrossbow it_Bow;

            public InternalTarget(AdvancedHeavyCrossbow bow)
