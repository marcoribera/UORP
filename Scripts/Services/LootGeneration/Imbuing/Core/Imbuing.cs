...
namespace Server.SkillHandlers
{
    public class Imbuing
    {
        ...
        {
            new SkillName[] { SkillName.Atirar, SkillName.Bloqueio, SkillName.Briga, SkillName.Contusivo, SkillName.Cortante, SkillName.DuasMaos, SkillName.Perfurante, SkillName.UmaMao},
            new SkillName[] { SkillName.Anatomia, SkillName.Bushido, SkillName.Envenenamento, SkillName.Ninjitsu, SkillName.PreparoFisico, SkillName.UmaMao},
            new SkillName[] { SkillName.Carisma, SkillName.Furtividade, SkillName.Mecanica, SkillName.Pacificar, SkillName.Percepcao, SkillName.Prestidigitacao, SkillName.Provocacao, SkillName.Sobrevivencia, SkillName.Tocar},
            new SkillName[] { SkillName.Arcanismo, SkillName.Caos, SkillName.Feiticaria, SkillName.ImbuirMagica, SkillName.Misticismo, SkillName.Necromancia, SkillName.Ordem, SkillName.PoderMagico, SkillName.ResistenciaMagica},
            new SkillName[] { SkillName.Agricultura, SkillName.Alquimia, SkillName.Carpintaria, SkillName.Costura, SkillName.Culinaria, SkillName.Extracao, SkillName.Ferraria},
            new SkillName[] { SkillName.ConhecimentoArmaduras, SkillName.ConhecimentoArmas, SkillName.Erudicao, SkillName.Extracao, SkillName.Medicina, SkillName.Veterinaria},
        };
