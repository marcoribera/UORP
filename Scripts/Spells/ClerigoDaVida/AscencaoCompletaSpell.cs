...
{
    public class AscencaoCompletaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Ascenção Completa", "Totalis Ascensionis",
            203,
            9061,
            Reagent.Garlic,
        ...
        public AscencaoCompletaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly AscencaoCompletaSpell m_Owner;
            public InternalTarget(AscencaoCompletaSpell owner)
        ...
        private class InternalTimer : Timer
        {
            ...
            {
                AscencaoCompletaSpell.RemoveBless(Mobile);
            }
        }
    }
}
