...
{
    public class ErguerCadaverSpell: ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Erguer Cadáver", "Suscitare Mortuos",
            203,
            9031,
            Reagent.GraveDust,
            Reagent.DaemonBlood);
        ...
        public ErguerCadaverSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly ErguerCadaverSpell m_Owner;

            public InternalTarget(ErguerCadaverSpell owner)
