...
namespace Server.Items
{
	...
	{
        TextDefinition ICommodity.Description { get { return String.Format( Amount == 1 ? "{0} malt" : "{0} malt", Amount ); } }
	...
	{
        TextDefinition ICommodity.Description { get { return String.Format( Amount == 1 ? "{0} barley" : "{0} barley", Amount ); } }
        bool ICommodity.IsDeedable { get { return false; } }
        [Constructable]
