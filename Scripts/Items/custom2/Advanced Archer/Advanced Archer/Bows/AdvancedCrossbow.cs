...
namespace Server.Items
{
	...
	public class AdvancedCrossbow : CBaseRanged
	{
		...
		[Constructable]
		public AdvancedCrossbow() : base( 0xF50 )
		{
			Weight = 7.0;
			Layer = Layer.TwoHanded;
		}

        public AdvancedCrossbow(Serial serial)
            : base(serial)
		{
		}
		...
		{
            private AdvancedCrossbow it_Bow;

            public InternalTarget(AdvancedCrossbow bow)
