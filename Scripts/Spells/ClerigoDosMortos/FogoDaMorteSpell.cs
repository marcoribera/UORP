...
{
    public class FogoDaMorteSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Fogo da Morte", "Ignis Mortis",
            245,
            9042,
            Reagent.SpidersSilk,
            Reagent.SulfurousAsh);
        public FogoDaMorteSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly FogoDaMorteSpell m_Owner;
            public InternalTarget(FogoDaMorteSpell owner)
