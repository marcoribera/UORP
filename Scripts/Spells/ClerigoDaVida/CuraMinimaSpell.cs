...
{
    public class CuraMininaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Cura Mínima", "Minimum Curionis",
            224,
            9061,
            Reagent.Garlic,
            Reagent.Ginseng,
        ...
        public CuraMininaSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (this.CheckBSequence(m))
            {
                ...
                int toHeal = (int)(this.Caster.Skills[SkillName.Necromancia].Value * 0.1);
        ...
        {
            private readonly CuraMininaSpell m_Owner;
            public InternalTarget(CuraMininaSpell owner)
