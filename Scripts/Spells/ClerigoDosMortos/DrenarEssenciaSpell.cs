...
{
    public class DrenarEssenciaSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Drenar Essência", "Exhaurire Essentia",
            227,
            9031,
            Reagent.Nightshade,
            Reagent.Garlic,
        ...
        public DrenarEssenciaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly DrenarEssenciaSpell m_Owner;
            public InternalTarget(DrenarEssenciaSpell owner)
