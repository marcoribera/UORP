...
namespace Server.Items
{
	...
	public class ThrowingGloves : BaseRanged
	{
		...
		public override WeaponAbility SecondaryAbility
		{
			get
			{
				if ( GloveType == "Stones" ){ return WeaponAbility.ParalyzingBlow; }
				...
				else if ( GloveType == "Tomatoes" ){ return WeaponAbility.ParalyzingBlow; }
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				else if ( GloveType == "Stars" ){ GloveType = "Cards"; }
				else if ( GloveType == "Cards" ){ GloveType = "Tomatoes"; }
