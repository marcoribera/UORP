...
{
	public class ElfoAnimalTrainer : BaseVendor
	{
		private readonly List<SBInfo> m_SBInfos = new List<SBInfo>();

		[Constructable]
		public ElfoAnimalTrainer()
		...
		public ElfoAnimalTrainer(Serial serial)
			: base(serial)
		{ }
		...
		private class StableEntry : ContextMenuEntry
		{
			...
			private readonly ElfoAnimalTrainer m_Trainer;

			public StableEntry(ElfoAnimalTrainer trainer, Mobile from)
				: base(6126, 12)
			{
				m_Trainer = trainer;
				m_From = from;
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump(ElfoAnimalTrainer trainer, Mobile from, List<BaseCreature> list)
				: base(50, 50)
			{
				m_Trainer = trainer;
				m_From = from;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry(ElfoAnimalTrainer trainer, Mobile from)
				: base(6127, 12)
			{
				m_Trainer = trainer;
				m_From = from;
		...
		private class StableTarget : Target
		{
			...
			public StableTarget(ElfoAnimalTrainer trainer)
