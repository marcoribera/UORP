...
{
    public class ElevarInteligenciaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Elevar Inteligência", "Amplio Intelligentia",
            212,
            9061,
            Reagent.MandrakeRoot,
            Reagent.Nightshade);

        public ElevarInteligenciaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly ElevarInteligenciaSpell m_Owner;
            public InternalTarget(ElevarInteligenciaSpell owner)
