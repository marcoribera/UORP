...
namespace Server.Spells.Monge
{
    public class EsferaDeKiSpell : MongeSpell
    {
        ...
        {
            private readonly EsferaDeKiSpell m_Owner;
            public InternalTarget(EsferaDeKiSpell owner)
