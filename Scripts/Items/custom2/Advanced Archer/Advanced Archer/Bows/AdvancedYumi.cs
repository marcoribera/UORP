...
namespace Server.Items
{
	...
	public class AdvancedYumi : CBaseRanged
	{
		...
		[Constructable]
		public AdvancedYumi() : base( 0x27A5 )
		{
			Weight = 9.0;
			Layer = Layer.TwoHanded;
		}

        public AdvancedYumi(Serial serial)
            : base(serial)
		{
		}
		...
		{
            private AdvancedYumi it_Bow;

            public InternalTarget(AdvancedYumi bow)
