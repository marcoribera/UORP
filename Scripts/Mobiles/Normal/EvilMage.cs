...
{ 
    ...
    { 
        ...
        { 
            ...
            SetSkill(SkillName.PoderMagico, 75.1, 100.0);
            SetSkill(SkillName.Arcanismo, 75.1, 100.0);
            SetSkill(SkillName.ResistenciaMagica, 75.0, 97.5);
            SetSkill(SkillName.Anatomia, 65.0, 87.5);
            SetSkill(SkillName.Briga, 20.2, 60.0);
