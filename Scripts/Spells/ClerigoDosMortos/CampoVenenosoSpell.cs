...
{
    public class CampoVenenosoSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Campo venenoso", "Venenata Agri",
            230,
            9052,
            false,
            Reagent.BlackPearl,
        ...
        public CampoVenenosoSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly CampoVenenosoSpell m_Owner;
            public InternalTarget(CampoVenenosoSpell owner)
