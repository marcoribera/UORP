...
namespace Server.Mobiles
{
	...
	public class LesserRonin : BaseCreature
	{
		...
		[Constructable]
		public LesserRonin() : base( AIType.AI_Samurai, FightMode.Closest, 10, 1, 0.3, 0.6 )
		{
		...
		public LesserRonin( Serial serial ) : base( serial )
		{
		}
