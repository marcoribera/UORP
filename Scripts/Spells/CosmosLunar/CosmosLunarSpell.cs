...
{
    public abstract class CosmosLunarSpell : Spell
    {
        ...
        public CosmosLunarSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public static double GetCosmosLunarDamage(Mobile from)
        {
