...
{
    public class CuraModeradaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Cura Moderada", "Moderari Remedium",
            224,
            9061,
            Reagent.Garlic,
            Reagent.Ginseng,
        ...
        public CuraModeradaSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (this.CheckBSequence(m))
            {
                ...
                int toHeal = (int)(this.Caster.Skills[SkillName.Necromancia].Value * 0.4);
        ...
        {
            private readonly CuraModeradaSpell m_Owner;
            public InternalTarget(CuraModeradaSpell owner)
