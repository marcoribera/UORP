...
namespace Server.Mobiles
{
	...
	public class GasCloud : BaseCreature
	{
		...
		{
			return ( m.Str + ( m.Skills[SkillName.Arcanismo].Value + m.Skills[SkillName.Necromancia].Value ) ) / Math.Max( GetDistanceToSqrt( m ), 1.0 );
		}
		...
		public GasCloud() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.PoderMagico, 99.9 );
			SetSkill( SkillName.Cortante, 100.0 );
