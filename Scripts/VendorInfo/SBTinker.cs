    ...
    { 
        ...
        { 
            ...
            //    Add(new GenericBuyInfo("1024115", typeof(Key), 8, 20, 0x1013, 0));
             ...
             //   Add(new GenericBuyInfo(typeof(Lockpick), 12, 20, 0x14FC, 0, true));
                ...
                Add(new GenericBuyInfo(typeof(TinkersTools), 300, 3, 0x1EBC, 0));
              //  Add(new GenericBuyInfo(typeof(Board), 3, 20, 0x1BD7, 0, true));
             //   Add(new GenericBuyInfo(typeof(IronIngot), 5, 16, 0x1BF2, 0, true));
                Add(new GenericBuyInfo(typeof(SewingKit), 300, 3, 0xF9D, 0));

                Add(new GenericBuyInfo(typeof(DrawKnife), 300, 3, 0x10E4, 0));
              ...
              //  Add(new GenericBuyInfo(typeof(Inshave), 10, 20, 0x10E6, 0));
                ...
                Add(new GenericBuyInfo(typeof(ButcherKnife), 300, 3, 0x13F6, 0));

                Add(new GenericBuyInfo(typeof(Scissors), 300, 3, 0xF9F, 0));

                Add(new GenericBuyInfo(typeof(Tongs), 300, 3, 0xFBB, 0));

                Add(new GenericBuyInfo(typeof(DovetailSaw), 300, 3, 0x1028, 0));
              //  Add(new GenericBuyInfo(typeof(Saw), 15, 20, 0x1034, 0));

                Add(new GenericBuyInfo(typeof(Hammer), 300, 3, 0x102A, 0));
               // Add(new GenericBuyInfo(typeof(SmithHammer), 23, 20, 0x13E3, 0));
                Add(new GenericBuyInfo(typeof(TrapCraftingKit), 300, 3, 0x1EB8, 0)); // Trapcrafting

                // TODO: Sledgehammer

                Add(new GenericBuyInfo(typeof(Shovel), 300, 3, 0xF39, 0));

                Add(new GenericBuyInfo(typeof(MouldingPlane), 300, 3, 0x102C, 0));
               // Add(new GenericBuyInfo(typeof(JointingPlane), 10, 20, 0x1030, 0));
               // Add(new GenericBuyInfo(typeof(SmoothingPlane), 11, 20, 0x1032, 0));

                Add(new GenericBuyInfo(typeof(Pickaxe), 300, 3, 0xE86, 0));

                Add(new GenericBuyInfo(typeof(Drums), 300, 3, 0x0E9C, 0));
        ...
        { 
            ...
            { 
                ...
                Add(typeof(TrapCraftingKit), 25); // Trapcrafting
                Add(typeof(Board), 1);
                Add(typeof(Log), 1);
