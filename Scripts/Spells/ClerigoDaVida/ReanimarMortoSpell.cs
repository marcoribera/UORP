...
{
    public class ReanimarMortoSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Reanimar Morto", "Vivifica Mortuum",
            245,
            9062,
            Reagent.Bloodmoss,
            Reagent.Garlic,
        ...
        public ReanimarMortoSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly ReanimarMortoSpell m_Owner;
            public InternalTarget(ReanimarMortoSpell owner)
