...
{
    [CorpseName("corpo de TLSmamute")]
    public class TLSmamute : BaseMount
    {
        [Constructable]
        public TLSmamute()
            : this("TLSmamute")
        ...
        [Constructable]
        public TLSmamute(string name)
            : base(name, 1767, 1767, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA8;
            BodyValue = 1767;
            //Hue = 1175;
        ...
        public TLSmamute(Serial serial)
            : base(serial)
        {
        }
