...
namespace Server.Mobiles
{
    ...
    public class LesserEnslavedGreenGoblin : BaseCreature
    {
        [Constructable]
        public LesserEnslavedGreenGoblin()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "Globin Verde Escravizado";
            Body = 334;
            BaseSoundID = 0x600;
        ...
        public LesserEnslavedGreenGoblin(Serial serial)
            : base(serial)
        {
        }
