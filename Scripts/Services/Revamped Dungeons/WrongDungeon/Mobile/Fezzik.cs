...
namespace Server.Mobiles
{
    ...
    public class Fezzik : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetSkill(SkillName.ResistenciaMagica, 133.3, 151.9);
            this.SetSkill(SkillName.Anatomia, 120.3, 130.0);
            this.SetSkill(SkillName.Briga, 122.2, 128.9);
            this.SetSkill(SkillName.Anatomia, 10.0, 15.0);
            this.SetSkill(SkillName.Percepcao, 90.0);
            this.SetSkill(SkillName.Bloqueio, 95.0, 100.0);
