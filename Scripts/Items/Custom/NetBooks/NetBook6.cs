...
namespace Server.Items
{
    ...
    public class NetBook6 : Item
    {
        private static string DefaultURL = "http://www.gtop100.com/in.php?site=40853"; // set default url here
        ...
        [Constructable]
        public NetBook6(string url, string name)
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (i_Active && i_url != null)
            {
                if (IsChildOf(from.Backpack) || from.InRange(this, 1))
                    from.SendGump(new NetBookGump6(from, i_url));
            }
        }

        public NetBook6(Serial serial)
            : base(serial)
        {
        }
    ...
    #region Gump
    public class NetBookGump6 : Gump
    {
        private string m_URL;

        public NetBookGump6(Mobile owner, string URL)
            : base(25, 25)
        {
            owner.CloseGump(typeof(NetBookGump6));
