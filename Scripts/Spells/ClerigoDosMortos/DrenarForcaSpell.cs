...
{
    public class DrenarForcaSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Drenar Força", "Exhauriat Force",
            212,
            9031,
            Reagent.Garlic,
            Reagent.Nightshade);
        ...
        public DrenarForcaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly DrenarForcaSpell m_Owner;
            public InternalTarget(DrenarForcaSpell owner)
