...
{
    [CorpseName("corpo de TLSGrifo")]
    public class TLSGrifo : BaseMount
    {
        [Constructable]
        public TLSGrifo()
            : this("TLSGrifo")
        ...
        [Constructable]
        public TLSGrifo(string name)
            : base(name, 1750, 1750, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA8;
            BodyValue = 1750;
            //Hue = 1175;
