...
namespace Server.Mobiles
{
    ...
    public class CorrosiveSlime : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetSkill(SkillName.Envenenamento, 36.0, 49.1);
            SetSkill(SkillName.Anatomia, 0);
            SetSkill(SkillName.ResistenciaMagica, 15.9, 18.9);
            SetSkill(SkillName.Anatomia, 24.6, 26.1);
            SetSkill(SkillName.Briga, 24.9, 26.1);
