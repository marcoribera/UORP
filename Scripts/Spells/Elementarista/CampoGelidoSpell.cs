...
{
	public class CampoGelidoSpell : ElementaristaSpell
    {



        private static readonly SpellInfo m_Info = new SpellInfo(
         "Campo Gélido", "Gelito Campum",
         236,
         9031,
        ...
        public CampoGelidoSpell(Mobile caster, Item scroll)
		...
		{
			Caster.SendMessage( "Onde você quer que o campo mágico materialize?" );
			...
			private class InternalTimer : Timer
			{
				...
				protected override void OnTick()
				{
					...
					if ( !m_Item.Visible )
					{
						...
						{
							m_Item.ProcessDelta();
							Effects.SendLocationParticles( EffectItem.Create( m_Item.Location, m_Item.Map, EffectItem.DefaultDuration ), 0x376A, 9, 10, 0x480, 0, 5029, 0 );
						}
					}
		...
		{
			private CampoGelidoSpell m_Owner;

			public InternalTarget(CampoGelidoSpell owner ) : base( Core.ML ? 10 : 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
