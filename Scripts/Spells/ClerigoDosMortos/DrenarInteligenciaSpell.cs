...
{
    public class DrenarInteligenciaSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Drenar Mente", "Exhaurire Intelligentia",
            212,
            9031,
            Reagent.Ginseng,
            Reagent.Nightshade);
        public DrenarInteligenciaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly DrenarInteligenciaSpell m_Owner;
            public InternalTarget(DrenarInteligenciaSpell owner)
