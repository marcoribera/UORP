...
namespace Server.Mobiles
{
    ...
    public class Spite : Changeling
    {
        ...
        public Spite()
        {
            ...
            SetSkill(SkillName.Briga, 12.8, 16.7);
            SetSkill(SkillName.Anatomia, 102.6, 131.0);
            SetSkill(SkillName.ResistenciaMagica, 141.2, 161.6);
            SetSkill(SkillName.Arcanismo, 108.4, 119.2);
