...
{
    public class FogoDeVidaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Fogo da Vida", "Ignis Vitae",
            245,
            9042,
            Reagent.SpidersSilk,
            Reagent.SulfurousAsh);
        public FogoDeVidaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly FogoDeVidaSpell m_Owner;
            public InternalTarget(FogoDeVidaSpell owner)
