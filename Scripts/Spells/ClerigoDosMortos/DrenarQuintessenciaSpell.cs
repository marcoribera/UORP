...
{
    public class DrenarQuintessenciaSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Drenar Alma", "Exhaurire Anima",
            215,
            9031,
            Reagent.BlackPearl,
        ...
        public DrenarQuintessenciaSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly DrenarQuintessenciaSpell m_Owner;
            public InternalTarget(DrenarQuintessenciaSpell owner)
