...
namespace Server.Items
{
    ...
    public abstract class BaseAxe : BaseMeleeWeapon, IHarvestTool
    {
        ...
        public override void OnHit(Mobile attacker, IDamageable defender, double damageBonus)
        {
            ...
            if (!Core.AOS && defender is Mobile && (attacker.Player || attacker.Body.IsHuman) && Layer == Layer.TwoHanded && (attacker.Skills[SkillName.Anatomia].Value / 400.0) >= Utility.RandomDouble())
            {
