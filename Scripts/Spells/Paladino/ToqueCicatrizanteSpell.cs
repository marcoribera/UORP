...
{
    public class ToqueCicatrizanteSpell : PaladinoSpell
    {
        ...
        public ToqueCicatrizanteSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly ToqueCicatrizanteSpell m_Owner;
            public InternalTarget(ToqueCicatrizanteSpell owner)
