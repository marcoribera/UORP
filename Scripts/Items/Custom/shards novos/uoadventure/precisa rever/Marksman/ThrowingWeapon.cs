	...
	public class ThrowingWeapon : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				else if ( ammo == "Throwing Stars"  ){ ammo = "Throwing Cards"; ItemID = 0x4C29; Name = "throwing card"; }
				else if ( ammo == "Throwing Cards"  ){ ammo = "Throwing Tomatoes"; ItemID = 0x4C28; Name = "throwing tomato"; }
