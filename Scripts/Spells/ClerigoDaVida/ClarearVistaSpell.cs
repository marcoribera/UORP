...
{
    public class ClarearVistaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Clarear Vista", "Patet Sententia",
            236,
            9031,
        ...
        public ClarearVistaSpell(Mobile caster, Item scroll)
        ...
        {
            Caster.Target = new ClarearVistaAlvo(this);
        }
        ...
        private class ClarearVistaAlvo : Target
        {
            private readonly ClarearVistaSpell m_Spell;

            public ClarearVistaAlvo(ClarearVistaSpell spell)
