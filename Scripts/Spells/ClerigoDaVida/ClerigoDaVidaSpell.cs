...
{
    public abstract class ClerigoDaVidaSpell : Spell
    {
        ...
        public ClerigoDaVidaSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public static double GetClerigoDaVidaDamage(Mobile from)
        {
