...
namespace Server.Items
{
    public class ExplosiveGreaterTrap : BaseTinkerTrap
    {
        ...
        private static string m_ArmedName = "Uma armadilha de grande explosao armada";
        private static string m_UnarmedName = "Uma armadilha de grande explosao desarmada";
