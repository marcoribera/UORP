    ...
    public class SocoVulcanicoSpell : MongeSpell
        ...
        public void Target(Point3D p)
        {
            ...
            else if (CheckSequence())
            {
                ...
                int tiles = 3 ;
                int damage = 10 + (int)Math.Max(1, (skill / 24)) ;
                int duration = (int)Math.Max(1, skill / 24) ;
        ...
        {
            private readonly SocoVulcanicoSpell m_Owner;
            public InternalTarget(SocoVulcanicoSpell owner)
        ...
        public class InternalTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                foreach (Mobile m in targets)
                {
                    ...
                    SocoVulcanicoSpell.Table[m] = Core.TickCount + 1000;
                }
            ...
            {
                SocoVulcanicoSpell.DefragTable();
