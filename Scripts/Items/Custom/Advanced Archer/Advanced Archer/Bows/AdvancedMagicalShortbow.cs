...
namespace Server.Items
{
	...
	public class AdvancedMagicalShortbow : CBaseRanged
	{
		...
		[Constructable]
		public AdvancedMagicalShortbow() : base( 0x2D1F )
		{
			Weight = 10.0;
			Layer = Layer.TwoHanded;
		}

        public AdvancedMagicalShortbow(Serial serial)
            : base(serial)
		{
		}
		...
		{
            private AdvancedMagicalShortbow it_Bow;

            public InternalTarget(AdvancedMagicalShortbow bow)
