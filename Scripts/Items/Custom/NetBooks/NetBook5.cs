...
namespace Server.Items
{
    ...
    public class NetBook5 : Item
    {
        private static string DefaultURL = "http://www.gamesites200.com/ultimaonline/in.php?id=1789"; // set default url here
        ...
        [Constructable]
        public NetBook5(string url, string name)
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (i_Active && i_url != null)
            {
                if (IsChildOf(from.Backpack) || from.InRange(this, 1))
                    from.SendGump(new NetBookGump5(from, i_url));
            }
        }

        public NetBook5(Serial serial)
            : base(serial)
        {
        }
    ...
    #region Gump
    public class NetBookGump5 : Gump
    {
        private string m_URL;

        public NetBookGump5(Mobile owner, string URL)
            : base(25, 25)
        {
            owner.CloseGump(typeof(NetBookGump5));
