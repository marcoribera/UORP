...
{
    public class PurificarAreaSpell : ClerigoDaVidaSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Purificar Àrea", "Purga Area",
            215,
            9061,
            Reagent.Garlic,
            Reagent.Ginseng,
        ...
        public PurificarAreaSpell(Mobile caster, Item scroll)
            ...
            else if (this.CheckSequence())
            {
                ...
                if (targets.Count > 0)
                {
                    ...
                    for (int i = 0; i < targets.Count; ++i)
                    {
                        ...
                        if (poison != null)
                        {
                            int chanceToCure = 10000 + (int)(this.Caster.Skills[SkillName.Necromancia].Value * 75) - ((poison.RealLevel + 1) * 1750);
                            chanceToCure /= 100;
                            chanceToCure -= 1;
        ...
        {
            private readonly PurificarAreaSpell m_Owner;
            public InternalTarget(PurificarAreaSpell owner)
