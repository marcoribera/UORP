...
namespace Server
{
	...
	public static class SkillExtUtility
	{
		...
		public static readonly SkillName[] HealingSkills = {SkillName.Medicina, SkillName.Veterinaria};
		...
		public static readonly SkillName[] BardicSkills =
			{SkillName.Tocar, SkillName.Pacificar, SkillName.Provocacao, SkillName.Caos};
		...
		public static readonly SkillName[] HarvestSkills = { SkillName.Agricultura, SkillName.Extracao, SkillName.Sobrevivencia};
