...
{
    public abstract class ElementaristaSpell : Spell
    {
        ...
        public ElementaristaSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        {
            return (from.Skills[SkillName.Necromancia].Value + from.Skills[SkillName.Arcanismo].Value + from.Skills[SkillName.PoderMagico].Value + from.Skills[SkillName.Erudicao].Value) / 2;
        }
