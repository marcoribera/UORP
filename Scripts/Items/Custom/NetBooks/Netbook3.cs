...
namespace Server.Items
{
    ...
    public class NetBook3 : Item
    {
        private static string DefaultURL = "http://www.mmorpgtoplist.com/in.php?site=24686"; // set default url here
        ...
        [Constructable]
        public NetBook3(string url, string name)
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (i_Active && i_url != null)
            {
                if (IsChildOf(from.Backpack) || from.InRange(this, 1))
                    from.SendGump(new NetBookGump3(from, i_url));
            }
        }

        public NetBook3(Serial serial)
            : base(serial)
        {
        }
    ...
    #region Gump
    public class NetBookGump3 : Gump
    {
        private string m_URL;

        public NetBookGump3(Mobile owner, string URL)
            : base(25, 25)
        {
            owner.CloseGump(typeof(NetBookGump3));
