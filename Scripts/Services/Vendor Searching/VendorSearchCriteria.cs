    ...
    public class SearchCriteriaCategory
    {
        ...
        public static SearchCriteriaCategory[] AllCategories = new SearchCriteriaCategory[]
        {
            ...
            new SearchCriteriaCategory(Category.RequiredSkill, 18, 1154543, new SearchCriterionEntry[] { // Required Skill
				new SearchCriterionEntry(SkillName.Cortante, 1044100),
                new SearchCriterionEntry(SkillName.Contusivo, 1044101),
                new SearchCriterionEntry(SkillName.Perfurante, 1044102),
                new SearchCriterionEntry(SkillName.Atirar, 1044091),
                new SearchCriterionEntry(SkillName.Atirar, 1044117),
            }),
            new SearchCriteriaCategory(Category.Skill1, 19, 1114255, new SearchCriterionEntry[] { // Skill Group 1
                new SearchCriterionEntry(SkillName.Cortante, 1044100),
                new SearchCriterionEntry(SkillName.Perfurante, 1044102),
                new SearchCriterionEntry(SkillName.Contusivo, 1044101),
                new SearchCriterionEntry(SkillName.Arcanismo, 1044085),
                new SearchCriterionEntry(SkillName.Tocar, 1044089),
            }),
            new SearchCriteriaCategory(Category.Skill2, 20, 1114256, new SearchCriterionEntry[] { // Skill Group 2
                new SearchCriterionEntry(SkillName.Briga, 1044103),
                new SearchCriterionEntry(SkillName.Anatomia, 1044087),
                new SearchCriterionEntry(SkillName.Adestramento, 1044095),
                new SearchCriterionEntry(SkillName.Provocacao, 1044082),
                new SearchCriterionEntry(SkillName.PoderMagico, 1044092),
            }),
            new SearchCriteriaCategory(Category.Skill3, 21, 1114257, new SearchCriterionEntry[] { // Skill Group 3
                new SearchCriterionEntry(SkillName.Furtividade, 1044107),
                new SearchCriterionEntry(SkillName.Bloqueio, 1044065),
                //new SearchCriterionEntry(SkillName.Meditation, 1044106),
                new SearchCriterionEntry(SkillName.Adestramento, 1044062),
                new SearchCriterionEntry(SkillName.Caos, 1044075),
                new SearchCriterionEntry(SkillName.PreparoFisico, 1044110),
            }),
            new SearchCriteriaCategory(Category.Skill4, 22, 1114258, new SearchCriterionEntry[] { // Skill Group 4
                new SearchCriterionEntry(SkillName.Prestidigitacao, 1044093),
                new SearchCriterionEntry(SkillName.Anatomia, 1044061),
                new SearchCriterionEntry(SkillName.PoderMagico, 1044076),
                new SearchCriterionEntry(SkillName.Veterinaria, 1044099),
                new SearchCriterionEntry(SkillName.Necromancia, 1044109),
                new SearchCriterionEntry(SkillName.Bushido, 1044112),
                new SearchCriterionEntry(SkillName.Misticismo, 1044115),
            }),
            new SearchCriteriaCategory(Category.Skill5, 23, 1114259, new SearchCriterionEntry[] { // Skill Group 5
                new SearchCriterionEntry(SkillName.Medicina, 1044077),
                new SearchCriterionEntry(SkillName.ResistenciaMagica, 1044086),
                new SearchCriterionEntry(SkillName.Pacificar, 1044069),
                new SearchCriterionEntry(SkillName.Atirar, 1044091),
                new SearchCriterionEntry(SkillName.Ordem, 1044111),
            ...
            new SearchCriteriaCategory(Category.Skill6, 24, 1114260, new SearchCriterionEntry[] { // Skill Group 6
                new SearchCriterionEntry(SkillName.Extracao, 1044104),
                new SearchCriterionEntry(SkillName.Prestidigitacao, 1044088),
                new SearchCriterionEntry(SkillName.Extracao, 1044105)
            }),
