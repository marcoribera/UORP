...
namespace Server.Items
{
    ...
    {
        private static string DefaultURL = "http://endtimes.forumbuild.com/index.php"; // set default url here
        ...
        [Constructable]
        public NetBook(string url, string name)
    ...
    public class NetBookGump : Gump
    {
        ...
        public NetBookGump(Mobile owner, string URL)
            : base(25, 25)
        {
