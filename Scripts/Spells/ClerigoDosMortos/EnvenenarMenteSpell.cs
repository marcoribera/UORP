...
{
    public class EnvenenarMenteSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Envenenar a Mente", "Venenum Mentis",
            218,
            Core.AOS ? 9002 : 9032,
            Reagent.BlackPearl,
        ...
        public EnvenenarMenteSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly EnvenenarMenteSpell m_Owner;
            public InternalTarget(EnvenenarMenteSpell owner)
