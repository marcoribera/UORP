...
{
    public class FerimentoInternoSpell : MongeSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Ferimento Interno", "Internum Vulnus",
            212,
            Core.AOS ? 9001 : 9041
          );
        ...
        public FerimentoInternoSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly FerimentoInternoSpell m_Owner;
            public InternalTarget(FerimentoInternoSpell owner)
