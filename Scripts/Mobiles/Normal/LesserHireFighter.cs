...
{
    public class LesserHireFighter : BaseHire
    {
        [Constructable]
        public LesserHireFighter()
        {
            ...
            SetSkill(SkillName.Cortante, 32, 50);
            SetSkill(SkillName.Bloqueio, 40, 60);
            SetSkill(SkillName.Contusivo, 32, 50);
        ...
        public LesserHireFighter(Serial serial)
            : base(serial)
        {
        }
