...
SetResistance( ResistanceType.Energy, 40, 55 );SetSkill( SkillName.Briga, 90.1, 96.8 );
SetSkill( SkillName.Anatomia, 90.3, 99.3 );SetSkill( SkillName.ResistenciaMagica, 75.3, 90.0 );
SetSkill( SkillName.PreparoFisico, 65.5, 69.4 );Fame = 7000;Karma = -7000;Tamable = true;ControlSlots 
