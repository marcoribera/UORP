...
{
    public class BanimentoCelestialSpell : PaladinoSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Banimento Celestial", "Coelestis Exsil",
            263,
            9002,
            Reagent.Garlic,
        ...
        {
            private readonly BanimentoCelestialSpell m_Owner;
            public InternalTarget(BanimentoCelestialSpell owner)
