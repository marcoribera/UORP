...
namespace Server.Items
{
	public class MonsterContractType
	{
		public static MonsterContractType[] Get = new MonsterContractType[]
		{
			...
			new MonsterContractType (typeof(TLSGoblinArqueiro2), 				"Goblin Arqueiro Elite", 50),
			...
			new MonsterContractType (typeof(OrcChopper), 		"Lenhador",		50),
			...
			new MonsterContractType (typeof(TLSElementalDeLava), 				"Elemental de Lava",				60),
			new MonsterContractType (typeof(FireAnt), 				"Formigas de Lava",						40),
			new MonsterContractType (typeof(Minotaur), 				"Minotauros",				60),
			new MonsterContractType (typeof(LesserElfBrigand), 				"Elfos Brigand",			40),
			new MonsterContractType (typeof(ElfBrigand), 					"Elfo Salteador",					50),
			...
			new MonsterContractType (typeof(FrostTroll), 				"Troll Invasor",			60),
