	...
	public class MonsterSplatter : Item
	{
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if ( hurts )
			{
				...
				if ( this.Name == "hot magma" && !(m is TLSElementalDeLava) )
				{
					owner.DoHarmful( m );
				...
				else if ( this.Name == "glowing goo" && !(m is Beetle) && !(m is Beetle) )
				{
					owner.DoHarmful( m );
				...
				else if ( this.Name == "scorching ooze" && !(m is LavaLizard) )
				{
					owner.DoHarmful( m );
					Effects.SendLocationParticles( EffectItem.Create( m.Location, m.Map, EffectItem.DefaultDuration ), 0x36B0, 1, 14, 63, 7, 9915, 0 );
					int eSound = 0x229;
				...
				else if ( this.Name == "blue slime" && !(m is Slime) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
				...
				else if ( this.Name == "swamp muck" && !(m is SwampTentacle) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
				...
				else if ( this.Name == "poisonous slime" && !(m is Betrayer) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
                ...
                else if ( this.Name == "fungal slime" && !(m is EvilMage) && !(m is EvilMage) && !(m is EvilMage) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
					AOS.Damage( m, owner, Hurt( owner, 24, 48 ), 	50, 	0, 		0, 		50, 	0 );
				...
				else if ( this.Name == "spider ooze" && !(m is GiantSpider) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
					AOS.Damage( m, owner, Hurt( owner, 24, 48 ), 	50, 	0, 		0, 		50, 	0 );
			...
			/*	else if ( this.Name == "acidic ichor" && !(m is AntaurKing) && !(m is AntaurProgenitor) && !(m is AntaurSoldier) && !(m is AntaurWorker) )
				...
				else if ( this.Name == "thick blood" && !(m is BloodElemental) && !(m is BloodElemental) )
				{
					owner.DoHarmful( m );
				...
				else if ( this.Name == "infected blood" && !(m is Zombie) )
				{
					owner.DoHarmful( m );
					Effects.SendLocationParticles( EffectItem.Create( m.Location, m.Map, EffectItem.DefaultDuration ), 0x36B0, 1, 14, 0x25, 7, 9915, 0 );
					int eSound = 0x229;
				...
				else if ( this.Name == "green blood" && !(m is Titan) )
				{
					owner.DoHarmful( m );
					Effects.SendLocationParticles( EffectItem.Create( m.Location, m.Map, EffectItem.DefaultDuration ), 0x36B0, 1, 14, 0x25, 7, 9915, 0 );
					int eSound = 0x229;
				...
				else if ( this.Name == "toxic blood" && !(m is ToxicElemental) )
				{
					owner.DoHarmful( m );
					Effects.SendLocationParticles( EffectItem.Create( m.Location, m.Map, EffectItem.DefaultDuration ), 0x36B0, 1, 14, 0x25, 7, 9915, 0 );
					int eSound = 0x229;
				...
				else if ( this.Name == "freezing water" && !(m is SeaSerpent) && !(m is SeaSerpent) && !(m is SeaSerpent) && !(m is SeaSerpent) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
				...
				else if ( this.Name == "deep water" && !(m is WaterElemental) && !(m is WaterElemental) && !(m is WaterElemental) && !(m is WaterElemental) )
				{
					owner.DoHarmful( m );
					Effects.PlaySound( m.Location, m.Map, 0x4D1 );
				...
				{
					int pSkill = (int)(owner.Skills[SkillName.Envenenamento].Value/50);
					int tSkill = (int)(owner.Skills[SkillName.Percepcao].Value/33);
					int aSkill = (int)(owner.Skills[SkillName.Alquimia].Value/33);
