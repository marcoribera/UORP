...
{ 
    ...
    { 
            ...
            : base()
        {
            ...
            SetSkill(SkillName.ResistenciaMagica, 96.9, 96.9);
            SetSkill(SkillName.Anatomia, 94.0, 94.0);
            SetSkill(SkillName.Briga, 54.3, 54.3);
            SetSkill(SkillName.Necromancia, 94.0, 94.0);
            SetSkill(SkillName.PoderMagico, 54.3, 54.3);
