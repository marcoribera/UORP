...
{ 
    ...
    { 
        ...
        { 
            ...
            {
                Add(new GenericBuyInfo(typeof(BreadLoaf), 50, 10, 0x103B, 0, true));
             ...
             //   Add(new GenericBuyInfo(typeof(ApplePie), 7, 20, 0x1041, 0, true)); //OSI just has Pie, not Apple/Fruit/Meat
              ...
              //  Add(new GenericBuyInfo(typeof(LambLeg), 8, 20, 0x160A, 0, true));
                Add(new GenericBuyInfo(typeof(ChickenLeg), 70, 5, 0x1608, 0, true));
             ...
             //   Add(new GenericBuyInfo(typeof(WoodenBowlOfStew), 3, 20, 0x1604, 0));
              ...
              //  Add(new GenericBuyInfo(typeof(RoastPig), 106, 20, 0x9BB, 0, true));
                Add(new GenericBuyInfo(typeof(SackFlour), 30, 5, 0x1039, 0, true));
                Add(new GenericBuyInfo(typeof(JarHoney), 50, 5, 0x9EC, 0, true));
                Add(new GenericBuyInfo(typeof(RollingPin), 50, 3, 0x1043, 0));
                Add(new GenericBuyInfo(typeof(FlourSifter), 50, 3, 0x103E, 0));
                Add(new GenericBuyInfo("1044567", typeof(Skillet), 50, 3, 0x97F, 0));
            }
        }
        ...
        { 
            ...
            { 
                Add(typeof(CheeseWheel), 8);
                Add(typeof(CookedBird), 8);
                Add(typeof(RoastPig), 20);
                Add(typeof(Cake), 5);
