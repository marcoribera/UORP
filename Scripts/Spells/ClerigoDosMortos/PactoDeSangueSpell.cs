...
{
    public class PactoDeSangueSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Pacto de Sangue", "Sanguis Foedus",
            203,
            9031,
            Reagent.DaemonBlood,
            Reagent.DaemonBlood);
        ...
        public PactoDeSangueSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly PactoDeSangueSpell m_Owner;
            public InternalTarget(PactoDeSangueSpell owner)
