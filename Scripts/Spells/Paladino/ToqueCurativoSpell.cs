...
{
    public class ToqueCurativoSpell : PaladinoSpell
    {
        ...
        public ToqueCurativoSpell(Mobile caster, Item scroll)
     ...
     public override SpellCircle Circle
        ...
        {
            private readonly ToqueCurativoSpell m_Owner;
            public InternalTarget(ToqueCurativoSpell owner)
