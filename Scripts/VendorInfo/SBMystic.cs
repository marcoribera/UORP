...
namespace Server.Mobiles
{
    public class SBMystic : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            ...
            {
                Add(new GenericBuyInfo(typeof(PurgeMagicScroll), 250, 10, 0x2DA0, 0, true));
                Add(new GenericBuyInfo(typeof(EnchantScroll), 250, 10, 0x2DA1, 0, true));
                Add(new GenericBuyInfo(typeof(SleepScroll), 250, 10, 0x2DA2, 0, true));
                Add(new GenericBuyInfo(typeof(EagleStrikeScroll), 250, 10, 0x2DA3, 0, true));
