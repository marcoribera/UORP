...
{
    public class SonolenciaSpell : ClerigoDosMortosSpell
    {
        ...
        public SonolenciaSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        {
            public SonolenciaSpell Owner { get; set; }

            public InternalTarget(SonolenciaSpell owner)
                : this(owner, false)
            {
            }

            public InternalTarget(SonolenciaSpell owner, bool allowland)
