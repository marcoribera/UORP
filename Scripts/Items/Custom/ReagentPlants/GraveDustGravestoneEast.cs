...
Last modified by 
Filepath: scripts\_custom\items\ReagentPlants\GraveDustGravestoneEast.cs
Lines of code: 96
***********************************************************/
...
{
	public class GraveDustGravestoneEast : Item
	{
		...
		[Constructable]
		public GraveDustGravestoneEast() : base(Utility.RandomList(4459))
		{
			Name = "Old Gravestone";
			Weight = 0;
			Movable = false;
		...
		public GraveDustGravestoneEast( Serial serial ) : base( serial )
		{
		}
