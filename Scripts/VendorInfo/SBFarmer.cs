        ...
        { 
            public InternalBuyInfo() 
            {
              //  Add(new GenericBuyInfo("1031235", typeof(FreshGinger), 505, 10, 11235, 0));
                Add(new GenericBuyInfo(typeof(Cabbage), 20, 10, 0xC7B, 0, true));
              //  Add(new GenericBuyInfo(typeof(Cantaloupe), 6, 20, 0xC79, 0, true));
                Add(new GenericBuyInfo(typeof(Carrot), 20, 10, 0xC78, 0, true));
              //  Add(new GenericBuyInfo(typeof(HoneydewMelon), 7, 20, 0xC74, 0, true));
                Add(new GenericBuyInfo(typeof(Squash), 20, 10, 0xC72, 0, true));
                Add(new GenericBuyInfo(typeof(Lettuce), 20, 10, 0xC70, 0, true));
                Add(new GenericBuyInfo(typeof(Onion), 17, 10, 0xC6D, 0, true));
                Add(new GenericBuyInfo(typeof(Pumpkin), 40, 10, 0xC6A, 0, true));
              ...
              //  Add(new GenericBuyInfo(typeof(YellowGourd), 3, 20, 0xC64, 0, true));
                ...
                Add(new GenericBuyInfo(typeof(Watermelon), 50, 10, 0xC5C, 0, true));
                //Add( new GenericBuyInfo( typeof( EarOfCorn ), 3, 20, XXXXXX, 0 ) );
                Add(new GenericBuyInfo(typeof(Eggs), 25, 3, 0x9B5, 0, true));
                Add(new BeverageBuyInfo(typeof(Pitcher), BeverageType.Milk, 40, 10, 0x9AD, 0));
             ...
             //   Add(new GenericBuyInfo(typeof(Grapes), 3, 20, 0x9D1, 0, true));
                Add(new GenericBuyInfo(typeof(Apple), 25, 10, 0x9D0, 0, true));
                Add(new GenericBuyInfo(typeof(SheafOfHay), 30, 10, 0xF36, 0));
                Add(new GenericBuyInfo(typeof(Hoe), 50, 3, 3897, 0));
            }
        }
