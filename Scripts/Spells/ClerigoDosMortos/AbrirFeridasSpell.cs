...
{
    public class AbrirFeridasSpell : ClerigoDosMortosSpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            "Abrir Feridas", "Causa Vulnera",
            212,
            Core.AOS ? 9001 : 9041,
            Reagent.Nightshade,
            Reagent.SpidersSilk);
        public AbrirFeridasSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly AbrirFeridasSpell m_Owner;
            public InternalTarget(AbrirFeridasSpell owner)
