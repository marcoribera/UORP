...
{
    public class AuraPurificadoraSpell : ClerigoDaVidaSpell
    {
        public override SpellCircle Circle { get { return SpellCircle.Fourth; } }

        private static SpellInfo m_Info = new SpellInfo(
            "Aura Purificadora", "Purgans Aurea",
            230,
            9022,
            Reagent.Garlic,
            Reagent.Ginseng,
        ...
        public AuraPurificadoraSpell(Mobile caster, Item scroll)
        ...
        {
            public AuraPurificadoraSpell Owner { get; set; }

            public InternalTarget(AuraPurificadoraSpell owner)
                : this(owner, false)
            {
            }

            public InternalTarget(AuraPurificadoraSpell owner, bool allowland)
