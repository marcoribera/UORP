...
{
    [CorpseName("corpo do lagartinho")]
    [TypeAlias("Server.Mobiles.TLSMiniLagarto")]
    public class TLSMiniLagarto : BaseCreature
    {
        [Constructable]
        public TLSMiniLagarto()
        ...
        public TLSMiniLagarto(Serial serial)
            : base(serial)
        {
        }
